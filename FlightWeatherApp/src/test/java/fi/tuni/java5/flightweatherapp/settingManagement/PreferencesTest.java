...
//    @Test
//    public void testGet_currency_validation() {
//        pref.set_currency("Dollar");
//        assertNotEquals("Dollar", pref.getCurrency()); // Assuming getCurrency() returns the currency value
//
//        pref.set_currency("USD");
//        assertEquals("USD", pref.getCurrency());
//
//        assertThrows(IllegalArgumentException.class, () -> new Preferences("usd", WeatherAPICall.metricUnit, -1.0, -1));
//    }
//
...
//        assertTrue(pref.set_temperature_unit(WeatherAPICall.metricUnit));
